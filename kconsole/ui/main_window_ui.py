...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        icon = QIcon()
        icon.addFile(u":/icons/settings", QSize(), QIcon.Normal, QIcon.Off)
        ...
        self.actionLoggingConsole = QAction(MainWindow)
        self.actionLoggingConsole.setObjectName(u"actionLoggingConsole")
        icon1 = QIcon()
        icon1.addFile(u":/icons/terminal", QSize(), QIcon.Normal, QIcon.Off)
        self.actionLoggingConsole.setIcon(icon1)
        ...
        self.menuView.addAction(self.actionLoggingConsole)
        self.toolBar.addAction(self.actionLoggingConsole)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.actionLoggingConsole.setText(QCoreApplication.translate("MainWindow", u"Logging Console", None))
